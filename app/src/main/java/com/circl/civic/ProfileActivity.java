...
public class ProfileActivity  extends AppCompatActivity {
    ...
    private TextView profileNameTextView, profileLastnameTextView, profilePhonenoTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileLastnameTextView = findViewById(R.id.profile_lastname_textView);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange( DataSnapshot dataSnapshot) {
                ...
                profileLastnameTextView.setText(userProfile.getUserLastname());
    ...
    public void buttonClickedEditName(View view) {
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                String lastname = profileLastnameTextView.getText().toString();
                String phoneno =  profilePhonenoTextView.getText().toString();
                UserInformation userinformation = new UserInformation(name,lastname, phoneno);
    ...
    public void buttonClickedEditLastname(View view) {
        LayoutInflater inflater = getLayoutInflater();
        View alertLayout = inflater.inflate(R.layout.layout_custom_dialog_edit_lastname, null);
        final EditText etUserLastname = alertLayout.findViewById(R.id.et_userLastname);
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("Lastname Edit");
        // this is set the view from XML inside AlertDialog
        alert.setView(alertLayout);
        // disallow cancel of AlertDialog on click of back button and outside touch
        alert.setCancelable(false);
        ...
        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                databaseReference.child(user.getUid()).setValue(userinformation);
                databaseReference.child(user.getUid()).setValue(userinformation);
                etUserLastname.onEditorAction(EditorInfo.IME_ACTION_DONE);
            }
        });
        AlertDialog dialog = alert.create();
        dialog.show();
